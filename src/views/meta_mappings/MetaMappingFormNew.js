...
import styles from './MetaMappingFormNew.module.css'

const { Form, useForm } = ReactFinalForm

export const META_MAPPING_FORM_NEW_PATH = '/sms-config/new'
...
export const MetaMappingFormNew = () => {
    const history = useHistory()
    const [createMetaMapping] = useCreateMetaMappingMutation({
        onComplete: () => history.push(META_MAPPING_LIST_PATH),
    })
