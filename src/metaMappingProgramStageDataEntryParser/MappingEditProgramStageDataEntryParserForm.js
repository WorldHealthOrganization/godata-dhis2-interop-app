...
import { useReadMetaMappingProgramStageDataEntryParserQuery } from './useReadMetaMappingProgramStageDataEntryParserQuery'
...
export const MappingEditProgramStageDataEntryParserForm = ({
    commandId,
    onAfterChange,
    onCancel,
}) => {
    const {
        ...
        data: commandData,
    } = useReadMetaMappingProgramStageDataEntryParserQuery(commandId)

    const command = commandData?.smsMapping
...
MappingEditProgramStageDataEntryParserForm.propTypes = {
