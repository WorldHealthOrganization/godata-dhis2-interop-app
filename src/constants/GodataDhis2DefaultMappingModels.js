...
export const GODATA_DHIS_CASE_TASK = [
    ...
    '/api/outbreaks/18bf7ca8-e5d5-4633-9762-c4f6982e3c0d/cases',
    '?ou=ImspTQPwCqd&ouMode=DESCENDANTS&program=uYjxkTbwRNf&fields=id,name&skipPaging=true&skipMeta=true .json?program=uYjxkTbwRNf&fields=trackedEntityInstance,enrollments[events[dataValues[dataElement,value]]],attributes[attribute,value]',
    {
        firstName: 'string',
        gender: 'string',
        ...
        duplicateKeys: { name: ['string'], document: ['string'] },
...
export const GODATA_DHIS_CONTACT_TASK = [
    '/api/trackedEntityInstances/query.json /api/trackedEntityInstances/',
    '/api/outbreaks/8f84c8ab-b342-448c-8f3c-9a816a228127/contacts',
    '?ou=ImspTQPwCqd&ouMode=DESCENDANTS&program=uYjxkTbwRNf&fields=id,name&skipPaging=true&skipMeta=true .json?program=uYjxkTbwRNf&fields=trackedEntityInstance,enrollments[events[dataValues[dataElement,value]]],attributes[attribute,value]',
    {
        firstName: 'string',
        gender: 'string',
        ...
        dateOfReporting: '2021-12-19T07:11:31.150Z',
        isDateOfReportingApproximate: false,
        dateOfLastContact: '2021-12-19T07:11:31.150Z',
        dateOfInfection: '2021-12-19T07:11:31.150Z',
        dateOfOnset: '2021-12-19T07:11:31.150Z',
        dateBecomeCase: '2021-12-19T07:11:31.150Z',
        dateRanges: [
            {
                typeId: 'string',
                centerName: 'string',
                locationId: 'string',
                comments: 'string',
                startDate: '2021-12-19T07:11:31.150Z',
                endDate: '2021-12-19T07:11:31.150Z',
            },
        ],
        classificationHistory: [
            {
        ...
        dateOfOutcome: '2021-12-19T07:11:31.150Z',
        dateOfBurial: '2021-12-19T07:11:31.150Z',
        followUpTeamId: 'string',
        deletedByParent: 'string',
        hasRelationships: false,
        relationshipsRepresentation: [
        ...
        duplicateKeys: { name: ['string'], document: ['string'] },
        responsibleUserId: 'string',
        createdAt: '2021-12-19T07:11:31.150Z',
        createdBy: 'string',
        updatedAt: '2021-12-19T07:11:31.150Z',
        updatedBy: 'string',
        createdOn: 'string',
        deleted: false,
        deletedAt: '2021-12-19T07:11:31.150Z',
    },
    false,
    0,
    'Go.Data Contact',
