...
export const DeleteConstantsConfirmationDialog = ({
    onCancelClick,
    onDeleteClick,
}) => (
    <Modal dataTest={dataTest('gateways-deleteconfirmationdialog')}>
        ...
        <ModalContent>
            {i18n.t('Are you sure you want to delete the selected constants?')}
        </ModalContent>
        <ModalActions>
            <ButtonStrip>
                <Button
...
DeleteConstantsConfirmationDialog.propTypes = {
